...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<bvs-big-input-action></bvs-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<bvs-big-input-action [disabled]="true"></bvs-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<bvs-big-input-action fontSet="fas" fontIcon="fa-trash"></bvs-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<bvs-big-input-action label="delete"></bvs-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<bvs-big-input-action (action)="actionHandler()"></bvs-big-input-action>';
    fixture = createHostComponent(template);
